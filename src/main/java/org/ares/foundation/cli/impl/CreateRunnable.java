...
@Command(name = "make:runnable",
        ...
        version = "1.0")
public class CreateRunnable implements Runnable, Buildable, Confirmable {
    ...
    public void confirmSuccessMessage() {
        System.out.println("Successfully created a new RunnableTask class!");
    }

    @Override
    public void run() {
        new TemplateBuilder(PROPERTY_KEY, StringUtil.addTaskLabel(name), TEMPLATE, buildContext()).buildCommand();
