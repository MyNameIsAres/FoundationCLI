...
@Command(name = "make:conversation", aliases = "conv",
        ...
        version = "1.0")
public class CreateSimpleConversation implements Runnable, Buildable, Confirmable {
    ...
    public void confirmSuccessMessage() {
        System.out.println("Successfully created a new SimpleConversation class!");
    }

    @Override
    public void run() {
        new TemplateBuilder(PROPERTY_KEY, StringUtil.addConversationLabel(name), TEMPLATE, buildContext()).buildCommand();
